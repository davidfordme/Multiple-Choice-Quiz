...
export class Convert {
    public static toQuizFile(json: string): QuizFile {
        return cast(JSON.parse(json), r("QuizFile"));
    }

    public static quizToJson(value: QuizFile): string {
        return JSON.stringify(uncast(value, r("QuizFile")), null, 2);
    }
}
